...
\begin{frame}{Other Desktops}
    ...
    \begin{tikzpicture}
        [remember picture, overlay, shift={(current page.north east)}]
        \node[anchor=north east,xshift=-3.3cm,yshift=-1.7cm]{\includegraphics[width=9cm]{KDE-Desktop-MacOS}};\pause
        \node[anchor=north east,xshift=-0.3cm,yshift=-1.7cm]{\includegraphics[width=9cm]{other-desktop-1}};\pause
        \node[anchor=north east,xshift=-3.3cm,yshift=-3.7cm]{\includegraphics[width=9cm]{other-desktop-2}};\pause
        \node[anchor=north east,xshift=-0.3cm,yshift=-3.7cm]{\includegraphics[width=9cm]{other-desktop-3}};\pause
    \end{tikzpicture}
